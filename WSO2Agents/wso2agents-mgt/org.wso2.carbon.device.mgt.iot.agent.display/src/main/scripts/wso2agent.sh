...
# ----------------------------------------------------------------------------
# Main Script for the WSO2 Carbon Agent
#
# Environment Variable Prequisites
#
#   DISPLAY_AGENT_HOME   Home of WSO2 Carbon installation. If not set I will  try
#                   to figure it out.
#
...
# using nohup sh to avoid erros in solaris OS.TODO
  nohup sh $CARBON_HOME/bin/wso2agent.sh $args > /dev/null 2>&1 &
  exit 0
elif [ "$CMD" = "test" ]; then
...
CARBON_CLASSPATH="$CARBON_CLASSPATH":"$JAVA_HOME"/jre/lib/jfxrt.jar

# ----- Execute The Requested Command -----------------------------------------

echo JAVA_HOME environment variable is set to $JAVA_HOME
echo CARBON_HOME environment variable is set to $CARBON_HOME
#echo CARBON_CLASSPATH environment variable is set to $CARBON_CLASSPATH
...
do
    ...
    -Ddisplay.agent.home="$CARBON_HOME" \
